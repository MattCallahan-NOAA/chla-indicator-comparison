...
options(timeout=600)
#Download two days of grid east of the dateline
#extent 47, 70, -130, -180
...
myyear <- 1998:2021
for(i in myyear){
  file_name <- paste0("Data/OCCCI/occ_annual_",i,".nc")
  download.file(url = paste0("https://coastwatch.pfeg.noaa.gov/erddap/griddap/pmlEsaCCI50OceanColorDaily.nc?chlor_a%5B(",
